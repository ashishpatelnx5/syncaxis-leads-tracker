...
export function AdminLeadsPage() {
  ...
  const load = useCallback(() => {
    setLoading(true);
    setError(null);
    fetchLeads({ q, status, productInterest, leadGeneratedBy, assignedTo, sortBy, sortDir, page, pageSize })
      .then((res) => {
        setItems(res.items);
        setTotal(res.total);
      })
  ...
  }, [q, status, productInterest, leadGeneratedBy, assignedTo, sortBy, sortDir, page, pageSize]);
