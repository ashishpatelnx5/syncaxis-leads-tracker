...
export function TeamPerformanceIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M4 20V11M10 20V6M16 20V13M20 4l-6 6-3-3-5 5" />
    </svg>
  );
}
...
export function EyeOffIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.2A10.6 10.6 0 0 1 12 5c6.5 0 10 7 10 7a17.9 17.9 0 0 1-3.4 4.3M6.5 6.6C3.7 8.4 2 12 2 12s3.5 7 10 7a9.9 9.9 0 0 0 4-.8" />
